...
TYPE_MULTI_TARGET_SINGLE_VALUE :: "%d targets on the left, but the right side is a single value — Mara does not broadcast it; assign each target separately, or call a function that returns %d values"
