...
TYPE_RUNTIME_SIZED_ARRAYS_SUPPORTED_USE :: "runtime-sized array needs the 'var' keyword:\n\n    name : var [..N]%s"
TYPE_ARRAY_SIZE_CONSTANT_COMPILE_TIME :: "array size constant '%s' is not a compile-time integer"
TYPE_RUNTIME_SIZED_ARRAYS_SUPPORTED_USE_2 :: "runtime-sized array needs the 'var' keyword:\n\n    name : var [..%s]%s"
...
TYPE_VAR_ONLY_USED_ARRAY_STRING :: "'var' can only be used with a runtime partial array '[..N]T' (or String), got %s"
