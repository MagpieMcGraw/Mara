...
TYPE_RUNTIME_SIZED_ARRAYS_SUPPORTED_USE :: "runtime-sized arrays are not supported. Use 'var' with Array instead:\n\n    import \"array\"\n    name : var [N]%s"
TYPE_ARRAY_SIZE_CONSTANT_COMPILE_TIME :: "array size constant '%s' is not a compile-time integer"
TYPE_RUNTIME_SIZED_ARRAYS_SUPPORTED_USE_2 :: "runtime-sized arrays are not supported. Use 'var' with Array instead:\n\n    import \"array\"\n    name : var [%s]%s"
...
TYPE_VARIABLE_LENGTH_ARRAYS_CANNOT_RETURNED :: "variable-length arrays cannot be returned from functions"
...
TYPE_VAR_REQUIRES_TYPE_ANNOTATION :: "'var' requires a type annotation"
TYPE_VAR_REQUIRES_SCOPE_ALLOCATOR_SET :: "'var' requires a scope allocator. Set up in main:\n\n    include mara.memory\n    program = Program(Arena_Basic)"
TYPE_VAR_ONLY_USED_ARRAY_STRING :: "'var' can only be used with Array or String types, got %s"
...
TYPE_RUNTIME_SIZED_TYPES_REQUIRE_VAR :: "runtime-sized types require the 'var' keyword:\n\n    %s : var %s"
...
TYPE_UTF8_NEEDS_SENTINEL :: "`[N]utf8`, `[]utf8`, and `[..N]utf8` are not types. The only valid utf8 storage types are the sentinel-terminated forms: `[N, 0]utf8`, `[, 0]utf8`, `[..N, 0]utf8`."
...
TYPE_CANNOT_ASSIGN_FIELD_TYPE :: "cannot assign %s to field '%s' of type %s"
...
TYPE_ARGUMENT_EXPECTED :: "argument %d of '%s': expected %s, got %s"
TYPE_ARGUMENT_VALUE_VLA_SHAPED_TYPE :: "argument %d of '%s': value has VLA-shaped type %s; mark the parameter `var` to accept runtime-sized instantiations"
...
CODE_CANNOT_TAKE_ADDRESS_EXPRESSION :: "cannot take address of this expression"
